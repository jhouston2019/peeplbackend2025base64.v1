...
// ── Feed card ─────────────────────────────────────────────
function NativeAd({ imgUrl, headline, sub }) {
  return (
    <div style={{ flexShrink: 0, marginBottom: 3, position: "relative" }}>
      <div style={{ height: 72, overflow: "hidden", position: "relative", background: "#222" }}>
        <img src={imgUrl} alt="ad" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block", opacity: 0.82 }} />
...
const ADS = [
  { imgUrl: "https://picsum.photos/id/425/500/80", headline: "Stella Artois",          sub: "She's a thing of beauty" },
  { imgUrl: "https://picsum.photos/id/15/500/80",  headline: "American Express Travel", sub: "Welcome to a world of rewards" },
  { imgUrl: "https://picsum.photos/id/431/500/80", headline: "Coca-Cola",               sub: "Open happiness. Stay refreshed." },
  { imgUrl: "https://picsum.photos/id/292/500/80", headline: "Five Guys Burgers",       sub: "Nothing beats a fresh burger" },
];
...
function Card({ venue, user, date, dist, status, mf, wait, ak, ages, pets, imgUrl, hasVideo }) {
  const [err, setErr] = useState(false);
  return (
    <div style={{ flexShrink: 0, marginBottom: 3 }}>
      <div style={{ height: 74, position: "relative", overflow: "hidden", background: "#334" }}>
        {!err && (
          <img src={imgUrl} alt="" onError={() => setErr(true)}
...
// ── Screen data ───────────────────────────────────────────
const S1 = [
  { venue: "Joey D's Oak Room",                    user: "anon-7b888",  date: "5/19/2017 8:29 PM",  dist: "3 miles away",   status: "PACKED!",  mf: "50/50",  wait: "Minutes", imgUrl: "https://picsum.photos/id/326/500/90" },
  { venue: "Georgia Intl Convention Center",       user: "anon-91703",  date: "5/15/2017 6:36 PM",  dist: "19 miles away",  status: "BUSY",     hasVideo: true, imgUrl: "https://picsum.photos/id/163/500/90" },
  { venue: "Osteria 832",                          user: "anon-7b888",  date: "5/14/2017 7:05 PM",  dist: "8 miles away",   status: "BUSY",     wait: "None",  imgUrl: "https://picsum.photos/id/292/500/90" },
  { venue: "Piedmont Park",                        user: "anon-7b888",  date: "5/13/2017 4:15 PM",  dist: "2 miles away",   status: "MODERATE", mf: "50/50",  ak: "30/70", pets: "A few", imgUrl: "https://picsum.photos/id/28/500/90" },
];

const S2 = [
  { venue: "Atlanta Airport TSA North Terminal",   user: "LordByron",   date: "10/11/2017 9:23 AM", dist: "68 miles away",  status: "PACKED!",  imgUrl: "https://picsum.photos/id/169/500/90" },
  { venue: "Monday Night Brewing",                 user: "LordByron",   date: "10/7/2017 5:24 PM",  dist: "74 miles away",  status: "BUSY",     imgUrl: "https://picsum.photos/id/312/500/90" },
  { venue: "Hartsfield Jackson Airport Domestic",  user: "LordByron",   date: "10/6/2017 8:43 PM",  dist: "68 miles away",  status: "PACKED!",  imgUrl: "https://picsum.photos/id/137/500/90" },
];

const S3 = [
  { venue: "Sivas Tavern",       user: "chazz26",   date: "11/4/2017 9:21 PM",  dist: "16 miles away", status: "LIGHT",    mf: "50/50", wait: "None",     imgUrl: "https://picsum.photos/id/453/500/90" },
  { venue: "Chomp & Stomp",      user: "LordByron", date: "11/4/2017 1:58 PM",  dist: "10 miles away", status: "PACKED!",  mf: "50/50", ak: "70/30", pets: "A few", imgUrl: "https://picsum.photos/id/237/500/90" },
  { venue: "Starbucks",          user: "jeff",      date: "10/25/2017 9:05 AM", dist: "5 miles away",  status: "MODERATE", wait: "A minute",  imgUrl: "https://picsum.photos/id/431/500/90" },
  { venue: "Two Birds Taphouse", user: "chazz26",   date: "10/24/2017 6:53 PM", dist: "13 miles away", status: "BUSY",     wait: "None", mf: "50/50", ages: "40-50, 30-40", imgUrl: "https://picsum.photos/id/392/500/90" },
];

const S4 = [
  { venue: "LA Fitness",               user: "LordByron", date: "6/12/2017 5:12 PM", dist: "2 miles away",   status: "MEDIUM",  imgUrl: "https://picsum.photos/id/416/500/90" },
  { venue: "Pure Taqueria Brookhaven", user: "LordByron", date: "6/7/2017 8:46 PM",  dist: "5246 feet away", status: "BUSY",    wait: "None", imgUrl: "https://picsum.photos/id/219/500/90" },
  { venue: "Food Terminal",            user: "jc",        date: "6/3/2017 8:24 PM",  dist: "1 mile away",    status: "PACKED!", hasVideo: true, imgUrl: "https://picsum.photos/id/180/500/90" },
  { venue: "",                         user: "",          date: "",                   dist: "",               status: "EMPTY",   hasVideo: true, imgUrl: "https://picsum.photos/id/299/500/90" },
];
