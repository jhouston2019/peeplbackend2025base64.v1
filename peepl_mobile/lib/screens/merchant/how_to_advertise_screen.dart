...
class HowToAdvertiseScreen extends StatelessWidget {
  ...
  static const _tiers = <_AdTier>[
    ...
    _AdTier(
      ...
      learnMore:
          ...
          'the feed. This guarantees maximum visibility at the top of the scroll ΓÇö '
    ...
    _AdTier(
      ...
      learnMore:
          'VIPeeps Exclusive ads reach Peepl\'s premium subscribers ΓÇö users who pay for '
  ...
  void _showTierDialog(BuildContext context, _AdTier tier) {
    // Inline detail ΓÇö no dialogs per merchant UX guidelines.
    Navigator.push(
      context,
  ...
  Widget _buildHeroSection() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text('≡ƒôú', style: TextStyle(fontSize: 40)),
          const SizedBox(height: 14),
          const Text(
  ...
  Widget _buildTierCard(BuildContext context, _AdTier tier) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: tier.isPopular ? _blue : PeeplMerchantTokens.border,
