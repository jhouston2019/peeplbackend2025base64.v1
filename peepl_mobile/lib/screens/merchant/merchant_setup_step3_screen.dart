...
class _MerchantSetupStep3ScreenState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: PeeplMerchantTokens.shellNavy,
                    ...
                    children: [
                      ...
                      OutlinedButton(
                        ...
                        style: OutlinedButton.styleFrom(
                          ...
                          side: const BorderSide(color: PeeplMerchantTokens.border),
                        ),
              ...
              child: const Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Submitting your ad…',
                      style: TextStyle(color: PeeplMerchantTokens.textPrimary, fontSize: 15),
                    ),
                  ],
                ),
              ),
  ...
  Widget _buildContextBox() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: PeeplMerchantTokens.accentBlue.withValues(alpha: 0.25),
        ),
      ),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
    ...
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: PeeplMerchantTokens.success,
          foregroundColor: PeeplMerchantTokens.textPrimary,
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(12),
          ),
